...
<table>
  <tr>
    <td width="76" align="center"><img src="images/etape_1.png" alt="1" width="56"></td>
    <td><b>Télécharge le launcher</b><br>Clique sur le bouton de ton ordinateur, juste au-dessus : Windows, Mac ou Linux.</td>
  </tr>
  <tr>
    <td width="76" align="center"><img src="images/etape_2.png" alt="2" width="56"></td>
    <td><b>Installe-le</b><br>Sur Windows, ouvre le fichier : le launcher s'installe tout seul et s'ouvre. Si Windows affiche un écran bleu, clique sur <b>Informations complémentaires</b>, puis <b>Exécuter quand même</b> : c'est normal pour un nouveau programme. Sur Mac et Linux, <a href="https://github.com/guerrinflorian/casteria-mc/releases/tag/installateur">la page d'installation</a> te montre chaque étape.</td>
  </tr>
  <tr>
    <td width="76" align="center"><img src="images/etape_3.png" alt="3" width="56"></td>
    <td><b>Joue</b><br>Choisis ton pseudo et clique sur <b>JOUER</b>. Le launcher prépare le jeu (quelques minutes la première fois), puis t'emmène directement sur le serveur.<br>En jeu, la première fois, tape <code>/register</code> puis un mot de passe que tu inventes (4 lettres ou chiffres au moins). Invente-le rien que pour Casteria : jamais celui de ton compte Microsoft ou de ta boîte mail. Les fois suivantes, tape <code>/login</code> puis ce mot de passe. Tu as une minute pour le faire.<br>Mot de passe oublié ? Demande au staff (Discord ou ticket sur le site de Casteria).</td>
  </tr>
</table>
...
<p align="center">
  <img src="images/launcher.png" alt="Le launcher de Casteria : le serveur en ligne, les nouvelles et le bouton JOUER" width="780">
</p>
...
<details>
<summary><b>Jouer sans le launcher</b></summary>
<br>
...
<p align="center">
  <sub>
    ...
    rien à y télécharger à la main.<br>
